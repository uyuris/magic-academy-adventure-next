...
export async function skipTraining({ root } = {}) {
...
export async function runTraining({ root, trainingId, randomSeed } = {}) {
  if (!root) throw new Error('root is required');
  ...
  const nextState = {
    ...state,
    current_screen: trainingProgress.completed ? 'academy-map' : nextTrainingScreen,
